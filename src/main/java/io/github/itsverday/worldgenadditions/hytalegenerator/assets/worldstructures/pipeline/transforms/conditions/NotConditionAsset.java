...
import io.github.itsverday.worldgenadditions.hytalegenerator.cartas.pipeline.transforms.conditions.NotCondition;
...
public class NotConditionAsset extends ConditionalPipelineCartaTransformAsset.ConditionAsset {
    ...
    public ConditionalPipelineCartaTransform.Condition build(@NonNullDecl PipelineCartaTransformAsset.Argument arg, PipelineCartaTransform previous) {
        ...
        return new NotCondition(condition.build(arg, previous));
    }
